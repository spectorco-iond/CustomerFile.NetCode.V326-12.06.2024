...
Public Class cMdb_Cus_Document
...
#Region "Private maintenance procedures ###################################"
    ...
    Private Sub SaveLine(ByRef pdrRow As DataRow)
        ...
        Try
            ...
            pdrRow.Item("Cus_Contact_Id") = m_intCus_Contact_Id
            pdrRow.Item("Main_Cus_Doc_Id") = m_intMain_Cus_Doc_Id
