...
#End Region
    ...
    '    '        '    Throw New exception(OEError.Year_Cannot_Be_LT_Previous_Year)
    '    '        'End If

    '    '        'If mcCalendar.SelectionRange.Start.Year > (Now.Year + 1) Then
    '    '        '    Throw New exception(OEError.Year_Cannot_Be_GT_Follow_Year)
    '    '        'End If
...
#Region "Private Date elements private events #############################"
    ...
    '                    e.Cancel = True
    '                    Throw New exception(OEError.Invalid_Date_Format)
    '                End If
...
#Region "Button procedures ################################################"
    ...
    '    Try
    '        If m_oOrder.Ordhead.ExportTS <> "" Then Throw New exception(OEError.Order_Exported_To_Macola)
    ...
    '                'Throw New exception(OEError.Delete_Successful)
    '            End If

    '        End If

    '    Catch oe_er As exception
