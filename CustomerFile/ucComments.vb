Public Class ucComments
    ...
    Public Shadows Sub Load(pCustomer As cCustomer)
        ...
        Try
            ...
            If dtComments Is Nothing Then
                ...
                Call CreateColumns(dgvComments)
        ...
        Try
            ...
            With dgv.Columns
                ...
                If dgv.Name = "dgvSearch" Then
                    .Add(DGVCalendarColumn("Update_TS", "Date Modified", 125))
                Else
    ...
    Private Sub ApplyFilters()
        ...
        Try
            ...
            tssRecordCount.Text = "Records: " & dgvComments.Rows.Count.ToString
    ...
    Private Sub dgvSearch_Sorted(sender As Object, e As System.EventArgs) Handles dgvSearch.Sorted
        ...
        Try
            ...
            oColumn = dgvComments.Columns(dgvSearch.SortedColumn.Index)
            oSortOrder = dgvSearch.SortOrder

            If oSortOrder = 1 Then
                dgvComments.Sort(oColumn, System.ComponentModel.ListSortDirection.Ascending)
            Else
                dgvComments.Sort(oColumn, System.ComponentModel.ListSortDirection.Descending)
            End If
    ...
    Private Sub dgv_ColumnWidthChanged(sender As Object, e As System.Windows.Forms.DataGridViewColumnEventArgs) Handles dgvSearch.ColumnWidthChanged, dgvComments.ColumnWidthChanged
        ...
        Try
            ...
            dgvSearch.HorizontalScrollingOffset = dgvComments.HorizontalScrollingOffset
    ...
    Private Sub dgvComments_DoubleClick(sender As Object, e As System.EventArgs) Handles dgvComments.DoubleClick
    ...
    Private Sub dgvComments_Scroll(sender As Object, e As System.Windows.Forms.ScrollEventArgs) Handles dgvComments.Scroll

        dgvSearch.FirstDisplayedScrollingColumnIndex = dgvComments.FirstDisplayedScrollingColumnIndex
    ...
    Private Sub Menu_Open()
        ...
        Try
            ...
            Dim oCus_Ship As New cMdb_Cus_Comment(dgvComments.CurrentRow.Cells(Columns.Cus_Comment_ID).Value)
    ...
    Private Sub Menu_Delete()
        Try
            Dim oMdb_Cus_Comment As New cMdb_Cus_Comment()

            If dgvComments.Rows.Count <> 0 Then

                oMdb_Cus_Comment = New cMdb_Cus_Comment(dgvComments.CurrentRow.Cells(Columns.Cus_Comment_ID).Value)
                oMdb_Cus_Comment.Delete()
