...
Public Class xCheckBox
    ...
    Private mTableSource As String
    Private mTableFieldSource As String
    Private mIsMultiLang As Boolean
    ...
    Public Property TableFieldSource() As String
        Get
            Return mTableFieldSource
        End Get
        Set(ByVal value As String)
            mTableFieldSource = value
        End Set
    End Property
    ...
    Private Sub xComboBox_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub xComboBox_KeyPress(ByVal sender As System.Object, _
    ...
    '    Private Sub xComboBox_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Validated
    Private Sub xComboBox_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Validated
    ...
    'Private Sub xComboBox_Click(ByVal sender As System.Object, _
    ...
    ''' Revert back to the display of numbers only whenever the user 
    ''' clicks in the box for editing purposes
    Private Sub xComboBox_GotFocus(ByVal sender As System.Object, _
    ...
    Private Sub xComboBox_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.TextChanged
